...
> **Junior DevOps Engineer** with **1.5 years** of hands-on experience at **Ezdat Technology Pvt Ltd, Gurugram**. Built a production-grade Netflix-style video streaming platform with FFmpeg, AWS S3, Docker, and Kubernetes.
...
- Built Netflix-style platform with FFmpeg + AWS S3 + React + K8s
- Automating Everything-as-Code to drive efficient, scalable workflows
- Production-grade Kubernetes Cluster Management and Docker Multi-stage Optimization
- Enterprise CI/CD Workflow Design with Jenkins + GitHub Actions
- Container scanning with Trivy + code analysis with SonarQube
...
| Orchestration | Advanced Kubernetes Pod lifecycle management, Replica scaling, HPA |
...
| Security and Config | Trivy image scanning, SonarQube, K8s ConfigMaps, Secrets, RBAC |
...
| Cloud | AWS S3 object storage, EC2, IAM, CloudFront CDN distribution |
...
**DevOps | Kubernetes | Docker | Jenkins | CI/CD | Monitoring | Automation | Linux | AWS | FFmpeg**
